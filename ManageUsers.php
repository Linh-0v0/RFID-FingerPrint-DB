	...
	<div class="form-style-5 slideInDown animated">
		<form enctype="multipart/form-data">
			...
			<fieldset>
				...
				<input type="text" name="number" id="number" placeholder="s_id...">
			...
			<fieldset>
			<legend><span class="number">2</span> User Fingerprint ID:</legend>
				<label>Enter Fingerprint ID between 1 & 127:</label>
				<input type="text" name="fingerid" id="fingerid" placeholder="User Fingerprint ID...">
